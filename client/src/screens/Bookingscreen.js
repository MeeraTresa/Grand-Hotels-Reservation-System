...
function Bookingscreen({ match }) {
    ...
    useEffect(async () => {
        ...
        try {
            setloading(true);
            const data = await (await axios.post("http://LB-23492172.us-west-1.elb.amazonaws.com:5000/api/rooms/getroombyid", {roomid})).data;
            console.log(data);
            setroom(data);
            setloading(false);
            ...
            const req = await axios.post('http://LB-23492172.us-west-1.elb.amazonaws.com:5000/api/users/rewards', {email: retrievedData.email});
    ...
    async function tokenHander(token) {
        ...
        async function updateData() {
            ...
            if(checked === true){
                ...
                axios.put('http://LB-23492172.us-west-1.elb.amazonaws.com:5000/api/users/reducereward',{email:reqdata[0].email,reward: reqdata2});
                
            }
            else{
                const req2 = axios.put('http://LB-23492172.us-west-1.elb.amazonaws.com:5000/api/users/updatereward',{email:reqdata[0].email,reward: reqdata2});
